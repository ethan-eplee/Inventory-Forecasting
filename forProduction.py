...
# --- 3) ALGORITHM CODE
# This is where the code will be written for the algorithm.
...
# --- 4) MAIN FUNCTION
# The algorithm code should contain modular code that can be run independently.
# Possibly want to include a final function that ties everything together, to allow
